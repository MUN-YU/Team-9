...
class ReviewPage extends StatefulWidget {
  ...
  const ReviewPage({super.key, required this.itemIdx});
...
class _ReviewPageState extends State<ReviewPage> {
  ...
  Future<void> fetchProducts(int itemIdx) async {
    final url = Uri.parse(
        'https://swe9.comit-server.com/mypage/rating?itemIdx=' +
            itemIdx.toString());
                      ...
                      Container(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment:
                                CrossAxisAlignment.start, // 자식들을 좌측 정렬
